<div class="s-result-item">
  <a href="<?php the_permalink();?>">
    ...
    <section class="s-result-item-info">
      <h3 class="s-result-item-name"><?php the_title();?></h3>
      <?php 
      if(!empty(get_the_terms(get_the_ID(), 'product_tag'))){
        ?><p class="s-result-item-tag"><?php
      ...
      <?php 
        ...
        ?>
          <p class="s-result-item-color-opt"><?php echo count(get_the_terms(get_the_ID(), "pa_color")); ?> 컬러</p>
        <?php
        }
      ?>
      <div class="s-result-item-price" data-sale="<?php echo
